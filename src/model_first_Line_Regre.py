...
#
#     logging.info("Inicjalizacja modelu")
#
#     model = LinearRegression() # regresja liniowa
#
#     logging.info("Dopasowywanie modelu (fit)")
#
#     model.fit(X_train, y_train) # fit modelu
#
...
#
#     logging.info("Wykonywanie predict")
#     start_time = time.perf_counter()
#
...
#
#     plt.scatter(X_test.iloc[:, 0], y_test, color="red", label="Prawda (y_test)")
#     plt.plot(X_test_sorted.iloc[:, 0], y_pred_sorted, color="blue", label="Opinia Modelu")
#     plt.legend()
#     plt.show()
#
# X_train, X_test, y_train, y_test = train_test_sets()
# y_pred = predict()
# rys(X_test, y_test, y_pred)
